...
export default function HousekeepingServicePage() {
  const features = [
    ...
    },
    {
      ...
      description: "Safe and environmentally conscious cleaning supplies",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#1E3A8A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Daily, weekly, or one-time cleaning services",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#1E3A8A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Deep cleaning, regular maintenance, and special requests",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#1E3A8A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  const services = [
    {
      name: "Daily Cleaning",
      price: "₦8,000",
      description: "Daily maintenance and tidying",
    },
    {
    ...
    },
    {
      name: "One-Time Clean",
      price: "₦12,000",
      description: "Single thorough cleaning session",
    },
    {
    ...
    <div className="py-16">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto text-lg">
          Keep your accommodation spotless and comfortable with our professional housekeeping services. 
          From daily maintenance to deep cleaning, we ensure your space stays immaculate throughout your stay.
        </p>
      </div>
      ...
      <div className="bg-[#1E3A8A]/5 rounded-xl p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Choose your preferred cleaning schedule and service type</p>
          </div>
          <div className="text-center">
            <div className="bg-[#1E3A8A] text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-xl font-bold">
              2
            ...
            <p className="text-gray-600">Our trained cleaners arrive with all necessary supplies</p>
          </div>
          <div className="text-center">
            <div className="bg-[#1E3A8A] text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-xl font-bold">
              3
            </div>
            <h3 className="font-bold text-lg mb-2">Spotless Results</h3>
            <p className="text-gray-600">Enjoy a perfectly clean and organized space</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-8 text-center">
        <h2 className="text-3xl font-bold mb-4 text-[#1E3A8A]">Ready for a Cleaner Space?</h2>
        <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
          Book your housekeeping service today and enjoy a consistently clean and comfortable accommodation.
        </p>
        <Link
