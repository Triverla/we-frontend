...
export default function PropertyTypePage() {
  ...
  useEffect(() => {
    if (!mounted || !propertyType) return;
    ...
    fetchProperties();
  }, [propertyType, currentPage, mounted, filters]);
  ...
  // Format property type name for display
  const formatPropertyTypeName = (type: string) => {
    return type
      .split("-")
      .map(word => {
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h1 className="text-3xl font-bold text-[#1E3A8A]">
              {formatPropertyTypeName(propertyType)} Properties
            </h1>
          </div>
          <p className="text-gray-600">
            {meta.total} {formatPropertyTypeName(propertyType).toLowerCase()} properties found
          </p>
        </div>
          ...
          <div className="lg:w-3/4">
            {properties.length === 0 ? (
              <div className="bg-white rounded-lg p-8 text-center">
                ...
                <p className="text-gray-600">
                  Try adjusting your filters to find more {formatPropertyTypeName(propertyType).toLowerCase()} properties.
                </p>
              </div>
            ) : (
              <>
